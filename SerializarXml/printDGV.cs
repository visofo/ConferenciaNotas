    ...
    class printDGV
    {
        ...
        public static void Print_DataGridView(DataGridView dgv1)
        {
            ...
            try
            {
                ...
                printDoc.DefaultPageSettings.Margins.Right = 80;
                ...
                ppvw.Name = "PrintPreviewControl1";
                ppvw.Dock = DockStyle.Fill;
                ppvw.Location = new System.Drawing.Point(60, 60);
        ...
        private static void PrintDoc_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            int tmpLeft = e.MarginBounds.Left - 90;
            ...
            try
            {
                ...
                if (PageNo == 1)
                {
                    foreach (DataGridViewColumn GridCol in dgv.Columns)
                    {
                        ...
                        //if (GridCol.AutoSizeMode.ToString() == "AllCellsExceptHeader")
                        //{
                    ...
                    int RowsPerPage)
        {
            ...
            float x = (e.MarginBounds.Left + (e.MarginBounds.Width -
                e.Graphics.MeasureString(PageNum, dgv.Font,
                e.MarginBounds.Width).Width) / 2);

            float y = e.MarginBounds.Top + e.MarginBounds.Height + 31;

            e.Graphics.DrawString(PageNum, dgv.Font, Brushes.Black, x, y);
        }
    }
}
